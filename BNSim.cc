...
int main(int argc, char** argv)
{
	...
	runManager->SetUserInitialization(new BNSimDetectorConstruction());

	//// Physics list
	//runManager->SetUserInitialization(new BNSimPhysicsList());
	//G4cout << "BNSimPhysicsList" << G4endl;
	...
	runManager->SetUserInitialization(new BNSimActionInitialization());
